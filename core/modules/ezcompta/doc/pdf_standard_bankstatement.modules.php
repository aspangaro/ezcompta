...
/**
 *  \file       core/modules/ezcompta/doc/pdf_standard.modules.php
 *  \ingroup    ezcompta
...
/**
 *	Class to manage PDF template standard_bankstatement
 */
class pdf_standard_bankstatement extends ModelePDFBankStatement
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	BankStatement	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('EZCOMPTA_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('EZCOMPTA_DRAFT_WATERMARK')));
		}
