...
/**
 *  \file       htdocs/core/modules/ezcompta/mod_bankstatement_standard.php
 *  \ingroup    ezcompta
...
/**
 *	Class to manage the Standard numbering rule for BankStatement
 */
class mod_bankstatement_standard extends ModeleNumRefBankStatement
{
	...
	public function canBeActivated($object)
	{
		...
		$sql .= " FROM ".MAIN_DB_PREFIX."ezcompta_bankstatement";
