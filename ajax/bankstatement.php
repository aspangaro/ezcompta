...
/**
 *       \file       htdocs/ezcompta/ajax/bankstatement.php
 *       \brief      File to return Ajax response on bankstatement list request
 */
...
// Security check
if (!$user->hasRight('ezcompta', 'bankstatement', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax ezcompta/ajax/bankstatement.php");
